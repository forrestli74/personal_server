...
type EndOfLifeSetting struct {
	MaxDurationInSeconds uint32   `protobuf:"varint,1,opt,name=max_duration_in_seconds,json=maxDurationInSeconds,proto3" json:"max_duration_in_seconds,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *EndOfLifeSetting) GetMaxDurationInSeconds() uint32 {
	if m != nil {
		return m.MaxDurationInSeconds
	}
	return 0
}
