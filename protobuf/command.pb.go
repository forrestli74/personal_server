...
func (m *CreateRoomRequest) GetShortDescription() string {
	if m != nil {
...
func (m *ListRoomResponse) GetRooms() []*RoomSummary {
	if m != nil {
		return m.Rooms
	}
	return nil
...
func (m *RoomSummary) String() string { return proto.CompactTextString(m) }
func (*RoomSummary) ProtoMessage()    {}
func (*RoomSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_6997e64cf7b5f9bb, []int{11}
}

func (m *RoomSummary) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RoomSummary.Unmarshal(m, b)
}
func (m *RoomSummary) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RoomSummary.Marshal(b, m, deterministic)
}
func (m *RoomSummary) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RoomSummary.Merge(m, src)
}
func (m *RoomSummary) XXX_Size() int {
	return xxx_messageInfo_RoomSummary.Size(m)
}
func (m *RoomSummary) XXX_DiscardUnknown() {
	xxx_messageInfo_RoomSummary.DiscardUnknown(m)
}

var xxx_messageInfo_RoomSummary proto.InternalMessageInfo

func (m *RoomSummary) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *RoomSummary) GetSetting() *RoomSetting {
	if m != nil {
		return m.Setting
	}
	return nil
...
func (m *RoomSummary) GetShortDescription() string {
	if m != nil {
		return m.ShortDescription
	}
	return ""
...
func (*DebugRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6997e64cf7b5f9bb, []int{12}
}
...
func (*DebugResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6997e64cf7b5f9bb, []int{13}
}
...
func (*RoomSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_6997e64cf7b5f9bb, []int{14}
}
...
func (m *RoomSetting) GetTick() *TickSetting {
	if m != nil {
		return m.Tick
	}
	return nil
...
func (m *RoomSetting) GetEndOfLife() *EndOfLifeSetting {
	if m != nil {
		return m.EndOfLife
	}
	return nil
...
func (*TickSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_6997e64cf7b5f9bb, []int{15}
}
...
func (m *TickSetting) GetFrequencyNanoseconds() uint64 {
	if m != nil {
		return m.FrequencyNanoseconds
	}
	return 0
}
...
type EndOfLifeSetting struct {
	...
	MaxDurationInNanoseconds uint64   `protobuf:"varint,1,opt,name=max_duration_in_nanoseconds,json=maxDurationInNanoseconds,proto3" json:"max_duration_in_nanoseconds,omitempty"`
	XXX_NoUnkeyedLiteral     struct{} `json:"-"`
	XXX_unrecognized         []byte   `json:"-"`
	XXX_sizecache            int32    `json:"-"`
}

func (m *EndOfLifeSetting) Reset()         { *m = EndOfLifeSetting{} }
func (m *EndOfLifeSetting) String() string { return proto.CompactTextString(m) }
func (*EndOfLifeSetting) ProtoMessage()    {}
func (*EndOfLifeSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_6997e64cf7b5f9bb, []int{16}
}

func (m *EndOfLifeSetting) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_EndOfLifeSetting.Unmarshal(m, b)
}
func (m *EndOfLifeSetting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_EndOfLifeSetting.Marshal(b, m, deterministic)
}
func (m *EndOfLifeSetting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EndOfLifeSetting.Merge(m, src)
}
func (m *EndOfLifeSetting) XXX_Size() int {
	return xxx_messageInfo_EndOfLifeSetting.Size(m)
}
func (m *EndOfLifeSetting) XXX_DiscardUnknown() {
	xxx_messageInfo_EndOfLifeSetting.DiscardUnknown(m)
}

var xxx_messageInfo_EndOfLifeSetting proto.InternalMessageInfo

func (m *EndOfLifeSetting) GetMaxDurationInNanoseconds() uint64 {
	if m != nil {
		return m.MaxDurationInNanoseconds
	}
	return 0
}

func init() {
	proto.RegisterType((*Commands)(nil), "tmp.Commands")
	...
	proto.RegisterType((*ListRoomRequest)(nil), "tmp.ListRoomRequest")
	proto.RegisterType((*ListRoomResponse)(nil), "tmp.ListRoomResponse")
	proto.RegisterType((*RoomSummary)(nil), "tmp.RoomSummary")
	...
	proto.RegisterType((*EndOfLifeSetting)(nil), "tmp.EndOfLifeSetting")
}
